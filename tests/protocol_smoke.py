...
with tempfile.TemporaryDirectory(prefix="runyard-protocol-") as tmp:
    ...
    try:
        ...
        def api(path, payload=None):
            req = urllib.request.Request("http://localhost:18080" + path, headers={
        ...
        client_env = dict(env, RUNYARD_URL="http://localhost:18080")
        ...
        print("Native protocol passed: replay, duplicate runner fencing, process, telemetry, artifacts, CLI checksum download")
    finally:
